#!/usr/bin/env python3
# create_ec2_dev_auth-bank.py
#
# Last Updated: 2019.10.21
# Updated by: jun.go@peertec.com
#
# This script uses boto3 to create an EC2 instance that will be used
# for auth-bank test in AWS DEV. This server allows TCP ports 80, 8080,
# 8081, and 4119 from the DEV VPC IP range 172.28.0.0/14 and TCP 22 from
# the wireguard VPN server.
...
def main():
    ...
    my_inst_name = 'gdac-dev-auth-bank'
