#!/usr/bin/env python3
# create_ec2_gdac_prod_xchg_service_admin.py
#
# Last Updated: 2019.02.28
# Updated by: scott.hwang@peertec.com
#
# This script uses boto3 to create an EC2 instance that will be used
# as the service-admin server for PROD envo. This server connects to
# AuroraDB PROD and also allows connections on TCP 5000. This server
...
def main():
    ...
    my_inst_name = 'gdac-prod-exchange-service-admin'
