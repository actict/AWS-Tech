#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_grow-vault.py
#
...
# for all EC2 'grow-vault' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'grow-vault' : [sns_topic_dict['grow-vault'],
                    instance_id_dict['grow-vault'], '',
                    ['cloudwatch', 'vault']]
         }
