#!/usr/bin/env python3
# create_all_cloudwatch_EC2_alarms_for_cruiser.py
#
# Last Updated: 2019.03.06
# Updated by: scott.hwang@peertec.com
#
# This script will create CPU, Memory, root disk, status and process
# alarms for 'cruiser' server


import boto3
from lib_cloudwatch_alarms import *
from env_prod import iid_cruiser
from env_prod import sns_cruiser


def main():
    dictOfInst = {
        'cruiser' : [sns_cruiser, iid_cruiser, '',
                       ['cruiser']
        ],
    }
