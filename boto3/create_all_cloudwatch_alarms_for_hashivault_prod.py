#!/usr/bin/env python3
# create_all_cloudwatch_onprem_alarms_for_hashivault_prod.py
#
# Last Updated: 2019.05.28
# Updated by: scott.hwang@peertec.com
#
# This script will create CPU, Memory, root disk, and process alarms
# for the EC2 'hashivault' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'hvault' : [sns_topic_dict['hashivault'],
                    instance_id_dict['hashivault'], 'mnt-vault-data',
                    ['vault', 'cloudwatch']
        ],
    }
