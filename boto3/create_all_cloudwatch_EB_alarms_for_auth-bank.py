#!/usr/bin/env python3
# create_all_cloudwatch_EB_alarms_for_auth-bank.py
#
# Last Updated: 2018.12.21
# Updated by: scott.hwang@peertec.com
#
# This boto3 script creates Cloudwatch Alarms for Elastic Beanstalk
# Application 'whalex_auth', environment 'auth-bank'.
# The alarms include:
...
resp = ebClient.update_environment(
    ...
    EnvironmentName = eb_env_auth_bank,
    OptionSettings = [
        {
...
print("Create max disk usage alarm for EB envo %s" % eb_env_auth_bank)
...
print("Create max CPU usage alarm for EB envo %s" % eb_env_auth_bank)
...
print("Create EB envo health status alarm for %s" % eb_env_auth_bank)
