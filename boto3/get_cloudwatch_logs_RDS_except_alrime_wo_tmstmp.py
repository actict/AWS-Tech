...
# string 'alrime' in query results and that don't include a timestamp
# of the form "#Time: yymmdd"
...
def main():
    ...
    for i in range(len(payload)):
        if "alrime" not in payload[i]['message']:
            # include logs that don't have a timestamp
            if "# Time" not in payload[i]['message']:
