#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_tx-verifier.py
#
# Last Updated: 2019.12.17
# Updated by: scott.hwang@actwo.com
#
# This script will create CPU, Memory, root disk, and process alarms
# for all EC2 'tx' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'tx-verifier' : [sns_topic_dict['tx-veri'],
                    instance_id_dict['tx-veri'], '',
                    ['cloudwatch', 'tx-veri']]
         }
