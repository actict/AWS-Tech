#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_admin-tonghap.py
#
# Last Updated: 2018.12.21
# Updated by: scott.hwang@peertec.com
#
# This script will create CPU, Memory, root disk, status and process
# alarms for admin-tonghap server
...
def main():
    dictOfInst = {
        'admin-tonghap' : [sns_admin_tonghap, iid_admin_tonghap, '',
                       ['nginx', 'PM2', 'admin-access']
        ],
    }
