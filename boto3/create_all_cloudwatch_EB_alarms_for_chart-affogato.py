#!/usr/bin/env python3
# create_all_cloudwatch_EB_alarms_for_chart-affogato.py
#
# Last Updated: 2018.12.14
# Updated by: scott.hwang@peertec.com
#
# This boto3 script creates Cloudwatch Alarms for Elastic Beanstalk
# Application 'delmoondo-chart', environment 'prod-delmoondo-chart-affogato-b'.
# The alarms include:
...
resp = ebClient.update_environment(
    ...
    EnvironmentName = eb_env_chart_affo_b,
    OptionSettings = [
        {
...
print("Create max disk usage alarm for EB envo %s" % eb_env_chart_affo_b)
...
print("Create max CPU usage alarm for EB envo %s" % eb_env_chart_affo_b)
...
print("Create EB envo health status alarm for %s" % eb_env_chart_affo_b)
