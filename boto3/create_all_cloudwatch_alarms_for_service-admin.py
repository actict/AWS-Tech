#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_service-admin.py
#
...
# for all EC2 'service-admin' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'service-admin' : [sns_topic_dict['service-admin'],
                    instance_id_dict['service-admin'], '',
                    ['nginx', 'cloudwatch', 'service-admin-prod']]
         }
