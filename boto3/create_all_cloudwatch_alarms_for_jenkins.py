#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_jenkins.py
#
...
# for all EC2 'jenkins' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'jenkins' : [sns_topic_dict['jenkins'],
                    instance_id_dict['jenkins'], '',
                    ['jenkins', 'cloudwatch']]
         }
