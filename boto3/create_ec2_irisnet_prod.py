#!/usr/bin/env python3
# create_ec2_irisnet_prod.py
#
# Last Updated: 2019.05.03
# Updated by: scott.hwang@peertec.com
#
# This script uses boto3 to create an EC2 instance that will be used
# as a irisnet full node in PROD envo. Irisnet is a near-identical
# fork of cosmos-sdk / tendermint
...
def main():
    ...
    my_inst_name = 'gdac-prod-exchange-irisnet-full'
        ...
        NetworkInterfaces = [
            {
                ...
                'Groups': [
                    ...
                    # allow 0.0.0.0/0 on TCP 26656, 10.0.0.0/16 on 26657
