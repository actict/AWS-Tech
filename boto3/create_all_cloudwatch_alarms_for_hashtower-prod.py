#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_hashtower-prod.py
#
...
# for all EC2 'hashtower-prod' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'hashtower-prod' : [sns_topic_dict['hashtower-web'],
                    instance_id_dict['hashtower-web'], '',
                    ['nginx', 'cloudwatch']]
         }
