#!/usr/bin/env python3
# create_ec2_prod_vault_for_blockeye.py
#
# Last Updated: 2019.07.16
# Updated by: scott.hwang@peertec.com
#
# This script uses boto3 to create an EC2 instance that will be used
# for Vault in AWS PROD. Only Grow Blockeye will be able to access
# Vault on port 8200. Note that for Amazon Linux 2 using gp2 ssd, the
# root disk will always use /dev/xvda device name while non-root disks
# use /dev/xvdY format.
...
def main():
    ...
    my_inst_name = 'gdac-prod-exchange-grow-vault'
        ...
        NetworkInterfaces = [
            {
                ...
                'Groups': [
                    sec_group_dict['vault-blockeye'],
                    sec_group_dict['wireguard-ssh']
                ],
                'AssociatePublicIpAddress': False
            }
        ],
        KeyName = ssh_keys_dict['log'],
        DryRun = False
    )
