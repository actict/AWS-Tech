#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_stat-dashboard.py
#
...
# for all EC2 'stat-dashboard' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'stat-dashboard' : [sns_topic_dict['stat-dashboard-cw'],
                    instance_id_dict['stat-dashboard'], '',
                    ['cloudwatch', 'internal', 'express', 'PM2']]
         }
