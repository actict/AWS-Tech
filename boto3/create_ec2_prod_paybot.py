#!/usr/bin/env python3
# create_ec2_prod_pay-orderbot.py
#
# Last Updated: 2019.10.15
# Updated by: scott.hwang@peertec.com
#
# This script uses boto3 to create an EC2 instance that will be used
# as a payments clearing server in AWS PROD. This server will also
...
def main():
    ...
    my_inst_name = 'gdac-prod-pay-orderbot'
    ...
    instance = ec2Resource.create_instances(
        ...
        KeyName = ssh_keys_dict['paybot-prod'],
        DryRun = False
    )
