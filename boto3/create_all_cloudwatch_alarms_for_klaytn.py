#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_klaytn.py
#
# Last Updated: 2020.02.10
# Updated by: scott.hwang@peertec.com
#
# This script will create CPU, Memory, root disk, and process alarms
# for the EC2 'klaytn' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'klaytn' : [sns_topic_dict['klaytn'],
                    instance_id_dict['klaytn'], '',
                    ['klaytn', 'cloudwatch']
        ],
    }
