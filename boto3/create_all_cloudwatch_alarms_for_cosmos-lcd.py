#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_cosmos-lcd.py
#
...
# for all EC2 'cosmos-lcd' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'cosmos-lcd' : [sns_topic_dict['cosmos-lcd'],
                    instance_id_dict['cosmos-lcd'], '',
                    ['cosmos-lcd', 'cloudwatch']]
         }
