#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_irisnet-lcd.py
#
...
# for all EC2 'irisnet-lcd' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'irisnet-lcd' : [sns_topic_dict['irisnet-lcd'],
                    instance_id_dict['irisnet-lcd'], '',
                    ['irisnet-lcd', 'cloudwatch']]
         }
