    ...
    IpPermissions = [
        {
            ...
            'IpRanges': [{
                ...
                'Description': 'access to marketapi.gdac.com'
            }],
            'ToPort': 443,
        },
        {
...
print("### Results of changing gmart-api LB idle timeout to 60 sec ###")
print(resp1)

print("### Results of opening SG ingress for gmart-api lb ###")
print(resp2)
