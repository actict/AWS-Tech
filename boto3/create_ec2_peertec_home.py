...
def main():
    ...
    my_inst_name = 'peertec-prod-wordpress-web'
        ...
        NetworkInterfaces = [
            {
                ...
                'Groups': [
                    sec_group_dict['peertec-web'],
                    sec_group_dict['wireguard-peer-ssh']
                ],
                'AssociatePublicIpAddress': False
            }
        ],
        KeyName = ssh_keys_dict['peertec-generic'],
        DryRun = False
    )
