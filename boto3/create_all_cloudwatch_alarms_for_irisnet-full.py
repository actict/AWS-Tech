#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_irisnet-full.py
#
...
# for all EC2 'irisnet-full' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'irisnet-full' : [sns_topic_dict['irisnet-full'],
                    instance_id_dict['irisnet-full'], '',
                    ['irisnet-full', 'cloudwatch']]
         }
