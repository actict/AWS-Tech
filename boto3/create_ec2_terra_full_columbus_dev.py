#!/usr/bin/env python3
# create_ec2_terra_full_columbus_dev.py
#
# Last Updated: 2019.05.20
# Updated by: scott.hwang@peertec.com
#
# This script uses boto3 to create an EC2 instance that will be used
# as a Terra full node (running Columbus mainnet) in DEV mainnet.
...
def main():
    ...
    my_inst_name = 'gdac-devmain-terra-full-columbus'
