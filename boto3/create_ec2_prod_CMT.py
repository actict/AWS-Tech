#!/usr/bin/env python3
# create_ec2_prod_CMT.py
#
# Last Updated: 2019.03.25
# Updated by: scott.hwang@peertec.com
#
# This script uses boto3 to create an EC2 instance that will be used
# as a CMT mainnet full-node in PROD environment. It communicates with
# both the Internet and Ted's wallet server.
...
def main():
    ...
    my_inst_name = 'gdac-prod-exchange-CMT'
