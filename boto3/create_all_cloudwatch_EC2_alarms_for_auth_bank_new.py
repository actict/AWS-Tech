#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_auth_bank_new.py
#
# Last Updated: 2019.01.28
# Updated by: scott.hwang@peertec.com
#
# This script will create CPU, Memory, root disk, status and process
# alarms for auth-bank-new EC2 server that replaces Elastic Beanstalk
# auth-bank
...
def main():
    dictOfInst = {
        'auth-bank-new' : [sns_auth_bank, iid_auth_bank_new, '',
                       ['authbankjs', 'nginx', 'pm2', 'cloudwatch']
        ],
    }
