#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_PL-batch.py
#
...
# for all EC2 'PL-batch' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'PL-batch' : [sns_topic_dict['PL-batch'],
                    instance_id_dict['PL-batch'], '',
                    ['PL-batch-venom', 'cloudwatch', 'PL-batch-spider']],
         }
