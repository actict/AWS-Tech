...
# Note that for ubuntu using gp2 ssd, the
...
def main():
    ...
    my_inst_name = 'gdac-prod-exchange-dashboard'
        ...
        NetworkInterfaces = [
            {
                ...
                'Groups': [
                    ...
                    sec_group_dict['stats-dashboard'],
                    sec_group_dict['wireguard-ssh']
                ],
                'AssociatePublicIpAddress': False
            }
        ],
        KeyName = ssh_keys_dict['sky'],
        DryRun = False
    )
