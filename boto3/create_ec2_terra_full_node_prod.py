...
# as a Terra mainnet full node in AWS PROD envo. This server needs to
# be able to communicate on TCP 26656 with the Internet for p2p with
# the Terra network and on TCP 26657 for RPC within the VPC.
...
def main():
    ...
    my_inst_name = 'gdac-prod-exchange-terra-full-node'
