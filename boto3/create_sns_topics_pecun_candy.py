#!/usr/bin/env python3
# create_sns_topics_pecun_candy.py
#
# Last Updated: 2019.07.03
# Updated by: scott.hwang@peertec.com
#
# This boto3 script will create multiple new AWS Simple Notification
# Service (SNS) topics for AWS PECUN candy servers and then add an
...
session = boto3.Session(profile_name = 'pecun_sns_full')
...
mydict = {
    ...
    'crawler-orderbook' : ['crawler-odrbk', 'crawlerOB'],
    'crawler-price' : ['crawler-price', 'crawlerPx'],
    'db-redis': ['db-redis', 'DBredis'],
    'deploy' : ['candy-deploy', 'cndyDeploy'],
    'halls' : ['halls', 'halls'],
    'halls-cow' : ['halls-cow', 'halls-cow'],
    'ricola' : ['ricola', 'ricola']
    }
