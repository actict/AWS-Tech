#!/usr/bin/env python3
# create_all_cloudwatch_alarms_for_sauron.py
#
...
# for all EC2 'fx' server running in AWS PROD Seoul region.
...
def main():
    ...
    dictOfInst = {
        ...
        'ledger' : [sns_topic_dict['sns_ledger'],
                    instance_id_dict['ledger'], '',
                    ['cloudwatch', 'PM2', 'admin', 'db2w', 'dcq', 'notification', 'otp', 'w2db', 'msg_sender', 'req_router', 'proc']]
         }
