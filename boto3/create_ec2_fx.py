#!/usr/bin/env python3
# create_ec2_dev_grow.py
#
# Last Updated: 2019.07.09
# Updated by: scott.hwang@peertec.com
#
# This script uses boto3 to create an EC2 instance that will be used
# for GROW in AWS DEV. Note that for Ubuntu 18.04 AMI using gp2 ssd,
...
def main():
    ...
    my_inst_name = 'gdac-devtest-exchange-fx'
        ...
        NetworkInterfaces = [
            {
                ...
                'Groups': [
                    sec_group_dict['exchange-fx'],
                    sec_group_dict['wireguard-ssh']
                ],
                'AssociatePublicIpAddress': False
            }
        ],
        KeyName = ssh_keys_dict['exchange-fx'],
        DryRun = False
    )
