#!/usr/bin/env bash
# collectd_cw_post_setup_terra-full.sh
#
...
# be executed as root on "terra-lcd" running Ubuntu 18.04
...
cat >> "$coldconf" <<EOF
<Plugin processes>
        ProcessMatch "terrad" "terrad start"
...
df-terrablocks-percent_bytes-used
processes.*
EOF
