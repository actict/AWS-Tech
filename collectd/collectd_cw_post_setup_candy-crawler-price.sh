#!/usr/bin/env bash
# collectd_cw_post_setup_candy-crawler-price.sh
#
...
# be executed as root on "crawler-price" running Ubuntu 18.04
...
cat >> "$coldconf" <<EOF
<Plugin processes>
        ProcessMatch "candy-crawler-price" "candy-crawler.jar"
