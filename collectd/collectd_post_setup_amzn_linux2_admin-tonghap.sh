#!/usr/bin/env bash
# collectd_post_setup_amzn_linux2_admin-tonghap.sh
#
...
# "admin-tonghap" server running Amazon Linux 2 with systemd (not
# upstart).
...
<Plugin processes>
        ...
        ProcessMatch "admin-access" "admin-api/bin/www"
</Plugin>
EOF
