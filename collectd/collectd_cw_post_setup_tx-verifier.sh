#!/usr/bin/env bash
# collectd_cw_post_setup_tx-verifier.sh
#
...
# "tx" running Ubuntu 18.04+ with systemd (not upstart).
...
cat >> "$coldconf" <<EOF
<Plugin processes>
        ProcessMatch "tx-veri" "/home/ec2-user/tx_verifier/transaction_verifier/app.py --host tx-verifier"
