#!/usr/bin/env bash
# collectd_cw_post_setup_bitgo-webhook-16.04.sh
#
...
# be executed as root on "bitgo-webhook" running Ubuntu 16.04
...
<Plugin processes>
        ...
        ProcessMatch "nginx" "master process /usr/sbin/nginx"
        ProcessMatch "node" "/home/ubuntu/myapp/myapp.js"
</Plugin>
EOF
...
df-bitgo-log-percent_bytes-used
processes.*
EOF
