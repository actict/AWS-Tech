#!/usr/bin/env bash
# collectd_post_setup_awslinux_auth-bank.sh
#
...
# be executed as root on David's auth-bank or auth-phone
# server running # an old version of Amazon Linux < v2 using
...
cat >> $coldconf <<EOF
<Plugin processes>
        ProcessMatch "authbankjs" "appAuthBank.js"
