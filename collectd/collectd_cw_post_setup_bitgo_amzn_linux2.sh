#!/usr/bin/env bash
# collectd_cw_post_setup_bitgo_amzn_linux2.sh
#
...
# be executed as root on bitgo server running Amazon Linux 2
...
<Plugin processes>
        ProcessMatch "bitgo" "node /path/to/my/app.js"
