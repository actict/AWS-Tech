# collectd_cw_post_setup_pl-batch.sh
#
...
# be executed as root on "PL-batch" running Ubuntu 16.04
...
cat >> "$coldconf" <<EOF
<Plugin processes>
        ProcessMatch "PL-batch" "venom-pro.jar"
        ProcessMatch "PL-batch" "spider-pro.jar"
