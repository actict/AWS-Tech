#!/usr/bin/env bash
# collectd_post_setup_amzn_linux2_admin-access.sh
#
...
# be executed as root on "admin-access" running Amazon Linux 2
# with systemd (not upstart).

# NOTE: this script is now deprecated in favor of
# collectd_post_setup_amzn_linux2_admin-tonghap.sh!! 2018.12.21
...
<Plugin processes>
        ...
        ProcessMatch "Elastic filebeat" "filebeat"
</Plugin>
EOF
