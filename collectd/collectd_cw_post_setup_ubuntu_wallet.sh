#!/usr/bin/env bash
# collectd_cw_post_setup_ubuntu_wallet.sh
#
...
# be executed as root on "wallet-svr" running Ubuntu 18.04
...
cat >> "$coldconf" <<EOF
<Plugin processes>
        ProcessMatch "wallet" "wallet_server.py"
        ProcessMatch "PM2" "God Daemon"
        ProcessMatch "filebeat" "/usr/share/filebeat/bin/filebeat"
</Plugin>
EOF
