#!/usr/bin/env bash
# collectd_cw_post_setup_candy-crawler-orderbook.sh
#
...
# be executed as root on "crawler-orderbook" running Ubuntu 18.04
...
cat >> "$coldconf" <<EOF
<Plugin processes>
        ProcessMatch "candy-crawler-orderbook" "candy-crawler.jar"
