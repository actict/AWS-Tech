...
log_grp="chart-svr_logs"
filterp='[loglevel=ERROR, ID, timestamp, msg]'
t_start=$(date -u +%F' '%H:%M:%S --date '-130 sec')
t_end=$(date -u +%F' '%H:%M:%S --date '-60 sec')
resultf="$appfolder/chart-svr-loglevel_error.log"
logfile="$appfolder/get_cw_logs_chart-svr_error.log"
### args for smtp-cli ###
slack_email="l4z6e8f0n9n3r3k0@whalex.slack.com"
mailhost="smtp.gmail.com"
mailuser="admin@actwo.com"
mailpw="$(<"$appfolder"/gmail_pass.txt)"
mailsubj="chart-svr loglevel:ERROR!"
