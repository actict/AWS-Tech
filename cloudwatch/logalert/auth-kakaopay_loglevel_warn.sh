#!/bin/bash
# auth-kakaopay_loglevel_warn.sh
#
# Last Updated: 2018.12.26
# Updated by: scott.hwang@peertec.com
#
# This script calls 'get_cloudwatch_logs.py' and runs a query against
# AWS Cloudwatch Logs to find all loglevel '[WARN]' events. If results
...
#
# This script is DEPRECATED in favor of the script
# 'auth-combined_loglevel_error_mkII.sh' for auth-bank/phone, and
# auth-kakaopay
