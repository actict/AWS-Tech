#!/bin/bash
# rds_error_log_alert_single_stream_prod-db-phoenix-ap-ne-2c.sh
#
...
#
# NOTE: This script only queries a single log stream
# from the log group '/aws/rds/cluster/prod-db-phoenix/error',
# log stream 'prod-db-phoenix-ap-northeast-2c'
...
logfile="$appfolder/get_cw_logs_RDS_errorlog_prod-db-phoenix-ap-ne-2c.log"
### args for smtp-cli ###
slack_email="f9x3u6h7i0w2e0m4@whalex.slack.com"
mailhost="smtp.gmail.com"
mailuser="admin@actwo.com"
mailpw="$(<"$appfolder"/gmail_pass.txt)"
mailsubj="RDS-Aurora 'Error Log' from 'prod-db-phoenix-ap-northeast-2c'!"
...
# resultf="$appfolder/RDS_errorlog_InnoDB_error_prod-db-phoenix-ap-ne-2c"
# mailsubj="RDS-Aurora 'InnoDB Error' from 'prod-db-phoenix-ap-northeast-2c'!"
