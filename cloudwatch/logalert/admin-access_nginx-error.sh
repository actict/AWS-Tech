...
resultf="$appfolder/admin-access_nginx-error-events.log"
logfile="$appfolder/get_cw_logs_admin-access_nginx_error.log"
### args for smtp-cli ###
slack_email="z4c7z8d0h8e6r8p3@whalex.slack.com"
mailhost="smtp.gmail.com"
mailuser="admin@actwo.com"
mailpw="$(<"$appfolder"/gmail_pass.txt)"
mailsubj="admin-access nginx error.log event!"
