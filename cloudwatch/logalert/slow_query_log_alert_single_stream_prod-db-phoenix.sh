#!/bin/bash
# slow_query_log_alert_single_stream_prodDBphnx.sh
#
...
logfile="$appfolder/get_cw_logs_RDS_slow_query_prod-db-phoenix.log"
### args for smtp-cli ###
slack_email="f9x3u6h7i0w2e0m4@whalex.slack.com"
mailhost="smtp.gmail.com"
mailuser="admin@actwo.com"
mailpw="$(<"$appfolder"/gmail_pass.txt)"
mailsubj="RDS-Aurora 'SLOW QUERY' from 'prod-db-phoenix'!"
